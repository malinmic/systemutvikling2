<template>
    <v-card elevation="4" height="125" class="mt-2" color="#E3F2FD">
        <v-card-actions>
            <v-list-item
            ...
            <h2 class="text-subtitle-1 font-weight-light mr-1">
                {{ score }}
            </h2>
            <v-icon color="#FDD835" icon="mdi-star" class="mr-2"></v-icon>
        </v-card-actions>
    </v-card>
</template>
